...
Curated quote generator with six category filters, clean transitions, and one-click copy or share.
...
- Quotes embedded as a JSON array in `app.js` — no API, no network calls
